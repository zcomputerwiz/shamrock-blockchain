...
def configure(
    ...
    if testnet:
        if testnet == "true" or testnet == "t":
            ...
            testnet_port = "58444"
            testnet_introducer = "beta1_introducer.shamrock.net"
            testnet_dns_introducer = "dns-introducer-testnet7.shamrock.net"
            testnet = "testnet7"
            ...
            mainnet_port = "8444"
            mainnet_introducer = "introducer.shamrock.net"
            mainnet_dns_introducer = "dns-introducer.shamrock.net"
            net = "mainnet"
