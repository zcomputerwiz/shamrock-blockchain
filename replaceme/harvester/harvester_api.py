...
from shamrock.harvester.harvester import Harvester
from shamrock.plotting.util import PlotInfo, parse_plot_info
from shamrock.protocols import harvester_protocol
from shamrock.protocols.farmer_protocol import FarmingInfo
from shamrock.protocols.harvester_protocol import Plot
from shamrock.protocols.protocol_message_types import ProtocolMessageTypes
from shamrock.server.outbound_message import make_msg
...
class HarvesterAPI:
    ...
    async def new_signage_point_harvester(
        self, new_challenge: harvester_protocol.NewSignagePointHarvester, peer: WSShamrockConnection
    ):
        """
