...
from shamrock.util.config import load_config, save_config, str2bool
...
def configure(
    ...
    if testnet:
        if testnet == "true" or testnet == "t":
            ...
            testnet_port = "58444"
            testnet_introducer = "beta1_introducer.shamrock.network"
            testnet_dns_introducer = "dns-introducer-testnet7.shamrock.network"
            testnet = "testnet7"
            ...
            mainnet_port = "8444"
            mainnet_introducer = "introducer.shamrock.network"
            mainnet_dns_introducer = "dns-introducer.shamrock.network"
            net = "mainnet"
    ...
    if change_made:
        print("Restart any running shamrock services for changes to take effect")
