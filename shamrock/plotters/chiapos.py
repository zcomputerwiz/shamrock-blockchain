"""
NOTE: This contains duplicate code from `shamrock.cmds.plots`.
After `shamrock plots create` becomes obsolete, consider removing it from there.
"""
import asyncio
import logging
...
def get_chiapos_install_info() -> Optional[Dict[str, Any]]:
    ...
    return {"display_name": "Shamrock Proof of Space", "version": chiapos_version, "installed": True}
...
def plot_shamrock(args, root_path):
