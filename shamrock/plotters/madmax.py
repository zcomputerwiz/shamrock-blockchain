...
from shamrock.plotting.create_plots import resolve_plot_keys
from shamrock.plotters.plotters_util import run_plotter, run_command
    ...
    if is_madmax_supported():
        ...
        run_command(
            [
                "git",
                "clone",
                "https://github.com/Shamrock-Network/shamrock-plotter-madmax.git",
                MADMAX_PLOTTER_DIR,
            ],
...
def plot_madmax(args, shamrock_root_path: Path, plotters_root_path: Path):
