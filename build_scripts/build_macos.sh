...
if [ "$NOTARIZE" == true ]; then
  electron-osx-sign Replaceme-darwin-x64/Replaceme.app --platform=darwin \
...
mv Replaceme-darwin-x64 ../build_scripts/dist/
cd ../build_scripts || exit

DMG_NAME="Replaceme-$REPLACEME_INSTALLER_VERSION.dmg"
echo "Create $DMG_NAME"
mkdir final_installer
electron-installer-dmg dist/Replaceme-darwin-x64/Replaceme.app Replaceme-$REPLACEME_INSTALLER_VERSION \
