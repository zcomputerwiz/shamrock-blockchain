...
from shamrock.pools.pool_config import PoolWalletConfig
from shamrock.util.config import load_config, save_config, create_default_shamrock_config
...
def test_pool_config():
    ...
    create_default_shamrock_config(test_root, ["config.yaml"])
