...
from shamrock.consensus.coinbase import create_farmer_coin
...
from shamrock.types.blockchain_format.foliage import TransactionsInfo
...
from shamrock.types.blockchain_format.slots import InfusedChallengeChainSubSlot
...
from shamrock.util.ints import uint8, uint64, uint32
...
class TestBodyValidation:
    ...
    async def test_minting_coin(self, empty_blockchain):
        ...
        print("spend=", spend)
        # this create coin will spend all of the coin, so the 10 clovers below
        # will be "minted".
